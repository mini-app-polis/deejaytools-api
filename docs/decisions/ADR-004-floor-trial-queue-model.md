...
`evaluator.yaml` referencing this ADR. To remove the
...
- docs/decisions/ADR-001-drizzle-migrations-at-deploy.md
  (migration delivery mechanism)
- docs/decisions/ADR-002-validation-envelope-shape.md
...
- evaluator.yaml — API-006 exemption referencing this ADR
