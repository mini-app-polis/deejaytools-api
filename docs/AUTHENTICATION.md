...
Sources: [`middleware/auth.ts`](../src/middleware/auth.ts), [`lib/optional-user.ts`](../src/lib/optional-user.ts), [`routes/auth.ts`](../src/routes/auth.ts), [`routes/admin-users.ts`](../src/routes/admin-users.ts), [`test/mocks.ts`](../src/test/mocks.ts), `verifyClerkToken` in [`common-typescript-utils`](https://www.npmjs.com/package/common-typescript-utils) (`dist/auth.js`), and frontend [`useAuthMe.ts`](https://github.com/mini-app-polis/deejaytools-com/blob/main/src/hooks/useAuthMe.ts), [`AuthSync.tsx`](https://github.com/mini-app-polis/deejaytools-com/blob/main/src/components/AuthSync.tsx), [`RequireAuth.tsx`](https://github.com/mini-app-polis/deejaytools-com/blob/main/src/components/RequireAuth.tsx), [`AdminGuard.tsx`](https://github.com/mini-app-polis/deejaytools-com/blob/main/src/components/AdminGuard.tsx), [`ManagerGuard.tsx`](https://github.com/mini-app-polis/deejaytools-com/blob/main/src/components/ManagerGuard.tsx).
...
2. `useApiClient()` calls `getToken()` and sets `Authorization: Bearer <jwt>` on each request ([`deejaytools-com` src/api/client.ts](https://github.com/mini-app-polis/deejaytools-com/blob/main/src/api/client.ts)).
...
[`AuthSync.tsx`](https://github.com/mini-app-polis/deejaytools-com/blob/main/src/components/AuthSync.tsx):

- Mounted inside [`Layout.tsx`](https://github.com/mini-app-polis/deejaytools-com/blob/main/src/components/Layout.tsx) under `<SignedIn>`.
- **`/` (LandingPage) is outside `Layout`** ([`App.tsx`](https://github.com/mini-app-polis/deejaytools-com/blob/main/src/pages/App.tsx)) — **sync does not run on the landing page**.
...
From [`useAuthMe.ts`](https://github.com/mini-app-polis/deejaytools-com/blob/main/src/hooks/useAuthMe.ts):
